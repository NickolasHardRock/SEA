...
export const procurarAluno = async (req, res) => {
  try {
    ...
    const aluno = await Aluno.findIndex(id);
...
export const inserirAluno = async (req, res) => {
  try {
    ...
    const novoAluno = await Aluno.create(matricula, turma, usuario_id);
...
export const atualizarAluno = async (req, res) => {
  try {
    ...
    const alunoAtualizado = await Aluno.update(matricula, turma, id);
