import * as Ocorrencia from '../models/OcorrenciaModel.js';
...
export const inserirOcorrencia = async (req, res) => {
  try {
    ...
    const novaOcorrencia = await Ocorrencia.create(datahora, tipo_ocorrencia, descricao, acao_tomada, registrado_por, aluno_id, gravidade_id);
...
export const atualizarOcorrencia = async (req, res) => {
  try {
    ...
    const ocorrenciaAtualizada = await Ocorrencia.update(id, tipo_ocorrencia, descricao, acao_tomada);
